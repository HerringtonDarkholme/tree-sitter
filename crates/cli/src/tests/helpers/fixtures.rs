...
pub fn get_test_fixture_language(name: &str) -> Language {
    ...
    get_test_language_internal(&parser_name, &parser_code, Some(&grammar_dir_path))
}
...
pub fn get_test_language(name: &str, parser_code: &str, path: Option<&Path>) -> Language {
    get_test_language_internal(name, parser_code, path)
}

fn get_test_language_internal(name: &str, parser_code: &str, path: Option<&Path>) -> Language {

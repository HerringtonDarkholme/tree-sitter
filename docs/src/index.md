...
Tree-sitter is a parser generator tool and parsing library. This fork builds a new concrete syntax tree from the complete
input on every parse. Tree-sitter aims to be:

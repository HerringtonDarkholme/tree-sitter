...
| Rejected | Narrow cursor parent-setup snapshot | Separate parent accessors for child pointer, count, and production ID | -1.20% traversal throughput; all seven languages negative | Inlined accessors already permit commoning; returning an aggregate worsens setup code shape |
